...
Treblle also uses the requests sent to your Dashboard to calculate your [API score](/treblle/api-score) which is a quality score that's calculated based on the performance, quality, and security best practices for your API.
