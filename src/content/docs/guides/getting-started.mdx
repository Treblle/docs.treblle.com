...
1. **Create a Treblle Account**
   ...
   First, [sign up for a free Treblle account](https://app.treblle.com/register). This gives you access to the Treblle dashboard where you'll be able to observe your APIs.

2. **Create Your First Project**
   
   After logging in:
   - Go to your [Treblle dashboard](https://app.treblle.com)
...
3. **Install the SDK**
   ...
   Can't find your platform? Check our complete [integrations list](/integrations/) or suggest it on our [Discord channel](https://treblle.com/chat).
...
- Check our detailed [documentation](/guides/)
- Join our [Discord community](https://treblle.com/chat)
