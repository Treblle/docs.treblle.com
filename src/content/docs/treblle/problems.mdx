---
  title: Problems
  description: Understand and manage errors captured by the Treblle SDK within the Problems tab of a project.
---
...
Treblle performs 15 security checks on every API request and assigns one of three threat levels:
