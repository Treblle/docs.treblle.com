...
<Schema
  item={{
    ...
    "@type": "VideoObject",
    name: "The Flows tab",
    description: "A series of API calls is called a Flow in Treblle.  Flows lets you group API requests that together are used to achieve a particular task like registering a user.   📞 CONNECT: 🌍 Website - https://treblle.com 😺 GitHub - https://github.com/Treblle 🐦 Twitter - https://twitter.com/treblleapi 👍🏽 Facebook - https://facebook.com/treblle 📪 Email - info@treblle.com  #treblle #projects #API #development",
    thumbnailUrl: "https://i.ytimg.com/vi/Iizl4eFTWms/default.jpg",
    uploadDate: "2022-11-29T11:50:53Z",
    duration: "PT3M4S",
...
<iframe class="w-full aspect-[16/9]" src="https://www.youtube.com/embed/Iizl4eFTWms" aria-label="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

A series of API calls is called a Flow in Treblle.

Flows lets you group API [requests](/treblle/requests/) that together are used to achieve a particular task like registering a user.
