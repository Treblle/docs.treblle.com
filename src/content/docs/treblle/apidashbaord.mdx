...
<img src="/platform/apidashboard/API-Dashboard.png" width="800" style={{ borderRadius: "8px" }} />
...
<img src="/platform/apidashboard/API-Dashboard-Demo-API.pngg" width="800" style={{ borderRadius: "8px" }} />
