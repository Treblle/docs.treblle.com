---
title: API Security
description: API Security in Treblle.
---


Treblle automatically scans every API Request for the most common security threats and vulnerabilities. Each threat and vulnerability carry a threat level impact, and the status of each check is graded with Pass/Fail along so users can quickly see an audit determining whether their API is at risk.

![](https://firebasestorage.googleapis.com/v0/b/treblle-docs.appspot.com/o/3dwvs_image.png?alt=media&token=dfa49a43-5cb6-416f-8326-4d5780f018e0)## Threat levels

When a request is sent to your API, Treblle assigns one of the following threat level impact ratings to that request:

\- \[Low\](#low) - \[Medium\](#medium) - \[High\](#high)

![](https://firebasestorage.googleapis.com/v0/b/treblle-docs.appspot.com/o/pcp7t_image.png?alt=media&token=d1aef86d-eb3e-4670-8034-7c37c757f6a9)## ## Security Audit
