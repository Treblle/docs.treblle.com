...
<Schema
  item={{
    ...
    "@type": "VideoObject",
    name: "Treblle - Autodection and grouping of API Endpoints",
    description: "A quick walkthrough where Vedran shows how you can benefit from Treblle's feature, where we autodetect and group your API's endpoints, and give observability and analytics data about them.  📞 CONNECT: 🌍 Website - https://treblle.com 😺 GitHub - https://github.com/Treblle 🐦 Twitter - https://twitter.com/treblleapi 👍🏽 Facebook - https://facebook.com/treblle 📪 Email - info@treblle.com  #treblle #APIObservability #API",
    thumbnailUrl: "https://i.ytimg.com/vi/4SdepMNHOl8/default.jpg",
    uploadDate: "2024-01-22T12:02:55Z",
    duration: "PT2M49S",
    embedUrl: "https://www.youtube.com/embed/4SdepMNHOl8",
    interactionCount: "50"
  }}
/>

<iframe class="w-full aspect-[16/9]" src="https://www.youtube.com/embed/4SdepMNHOl8?si=oKsK-IgjZdtQx-FL" aria-label="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

Your API endpoints are the URIs that exposes a particular part of your API for communications via [requests](/treblle/requests/).
...
- The [endpoint group](#endpoint-groups) the endpoint belongs to
...
Treblle automatically groups your endpoints. For example if you have two endpoints `/users/:id` and `/users/verify`, Treblle will group then under the `users` endpoint group. This makes it easy to [filter](#filters) for endpoints by groups.
...
- [Muted](#mute-an-endpoint) - for endpoints muted or not
