...
#### Steps to add the Customer ID in Treblle's [Express SDK](https://docs.treblle.com/integrations/javascript/express/)
...
Here's how you can modify your [Express](https://docs.treblle.com/integrations/javascript/express/) middleware to add the `Customer ID` to the request headers:
