...
You just need upload your OpenAPI specs (JSON or YAML) to get a score (1-100) and grade (A-F) in design, security, and performance.
...
#### Example: **API Insights of Demo API**

This report is based on Demo API data. The Demo API is a sample API included solely to showcase the functionality and features of the API Insights platform. It provides mock data that helps understand the working of the tool.

The Demo API does not represent a real-world API but serves as a practical example for learning and exploration within the API Insights platform.
