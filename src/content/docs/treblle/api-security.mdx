...
<Schema
  item={{
    ...
    description: "A quick walkthrough where Vedran shows how you can benefit with Treblle's Automated API Security checks.  See more: https://treblle.com/product/api-security  📞 CONNECT: 🌍 Website - https://treblle.com 😺 GitHub - https://github.com/Treblle 🐦 Twitter - https://twitter.com/treblleapi 👍🏽 Facebook - https://facebook.com/treblle 📪 Email - info@treblle.com  #treblle #APIsecurity #API",
    thumbnailUrl: "https://i.ytimg.com/vi/rMOGyFbu63k/default.jpg",
    uploadDate: "2024-01-22T12:17:40Z",
    duration: "PT3M28S",
    embedUrl: "https://www.youtube.com/embed/rMOGyFbu63k",
    interactionCount: "65"
  }}
/>

<iframe class="w-full aspect-[16/9]" src="https://www.youtube.com/embed/rMOGyFbu63k?si=fSvmSJXRT3AoGUry" aria-label="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

Treblle automatically scans every [requests](/treblle/requests/) to your APIs for the most common security threats and gives each request a [threat level](#threat-levels) if one or more security threat is found on the request.
