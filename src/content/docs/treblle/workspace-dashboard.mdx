...
metaTitle: "Workspace Dashboard | Treblle Docs"
description: "The **Workspace Dashboard** or the Home Page gives you a supercharged view across your entire API estate."
image: "/og-images/dashboard.jpg"
---

The **Workspace Dashboard** or the Home Page gives you a supercharged view across your entire API estate. It’s filterable with a **dashboard-level time filter**, making it easier to track what matters, when it matters.
