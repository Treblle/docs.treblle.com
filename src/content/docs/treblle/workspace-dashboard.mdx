The **New Workspace Dashboard** or the Home Page gives you a supercharged view across your entire API estate. It’s filterable with a **dashboard-level time filter**, making it easier to track what matters, when it matters.
...
- **Observe adoption, Governance, and Error Trends**: Spot issues, track usage, and align with your platform and business goals.
