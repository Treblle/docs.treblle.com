...
<Schema
  item={{
    ...
    description: "A quick walkthrough where Vedran shows how you can make use of the Treblle's API Score feature to up your API Governance game.  See more: https://treblle.com/product/api-governance  📞 CONNECT: 🌍 Website - https://treblle.com 😺 GitHub - https://github.com/Treblle 🐦 Twitter - https://twitter.com/treblleapi 👍🏽 Facebook - https://facebook.com/treblle 📪 Email - info@treblle.com  #treblle #apigovernance #API",
    thumbnailUrl: "https://i.ytimg.com/vi/hBNNa8Gv_fs/default.jpg",
    uploadDate: "2024-01-22T12:27:08Z",
    duration: "PT3M14S",
    embedUrl: "https://www.youtube.com/embed/hBNNa8Gv_fs",
    interactionCount: "66"
  }}
/>
