---
title: "How to Mask Sensitive API Data in Treblle | Treblle Docs"
description: "Learn how Treblle’s masking feature secures sensitive API data by replacing values with stars before leaving your server. Configure custom fields to enhance API privacy."
