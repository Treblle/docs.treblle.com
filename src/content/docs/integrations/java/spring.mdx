---
title: "Set Up Treblle in Spring | Treblle Docs"
description: "Integrate Treblle with Spring Boot to capture API requests, track errors, and improve visibility. Learn how to set up Treblle for real-time API insights"
image: "/og-images/treblle-spring.jpg"
---

<div class="max-w-full mx-auto shadow-lg rounded-lg overflow-hidden">
  <a href="https://github.com/Treblle/treblle-spring" title="View source on GitHub" aria-label="View source on GitHub" class="relative no-underline">
    <div>
    ...
    <div class="grid grid-cols-4 gap-4 px-2 py-2">
      <div class="col-span-4">
      	<h3 class="text-xl font-semibold">treblle-spring</h3>
...
Next, create a FREE account on [treblle.com](https://treblle.com) to get an API key and Project ID. After you have those simply initialize Treblle in your project like so:
