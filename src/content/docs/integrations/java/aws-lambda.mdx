...
<div class="max-w-full mx-auto shadow-lg rounded-lg overflow-hidden">
  <a href="https://central.sonatype.com/artifact/com.treblle/treblle-aws-lambda/1.0.2/overview" title="View source on GitHub" aria-label="View source on GitHub" class="relative no-underline">
    <div>
