...
image: "/og-images/treblle-javax.jpg"
---
    ...
    <div className="grid grid-cols-4 gap-4 px-2 py-2">
      <div className="col-span-4">
        ...
        <p className="text-sm font-medium">
          The official Treblle SDK for JavaX. Seamlessly integrate Treblle with JavaX Servlet API 3.1.0 and JavaX RS API 2.1.1 to monitor your API traffic, track errors, and secure sensitive data.
        </p>
      </div>
    </div>
  </a>
...
### Basic Configuration
To set up Treblle in your JavaX application, you'll need to configure the filter to intercept requests and responses. Here's a basic configuration example:
...
That's it! Your API requests and responses are now being sent to your Treblle project. You'll get features like: auto-documentation, real-time request/response monitoring, error tracking and so much more.
...
By default, Treblle applies its filter to all requests (/*). If you want to run Treblle only for certain URL patterns, you can specify them during filter registration:
