...
description: How to add Treblle to a Directus API.
---

<div class="max-w-full mx-auto shadow-lg rounded-lg overflow-hidden">
  <a href="https://github.com/Treblle/treblle-directus" title="View source on GitHub" aria-label="View source on GitHub" class="relative no-underline">
    <div>
    ...
    <div class="grid grid-cols-4 gap-4 px-2 py-2">
      <div class="col-span-4">
      	<h3 class="text-xl font-semibold">treblle-directus</h3>
      	<p class="text-sm font-medium">
          The official Treblle SDK for Directus. Seamlessly integrate Treblle to manage communication with your dashboard, send errors, and secure sensitive data.
        </p>
      </div>
    </div>
  </a>
