---
title: "Set Up Treblle in Node.js | Treblle Docs"
description: "Learn how to integrate Treblle with Node.js, Express, and NestJS. Capture API requests, enhance security, and gain real-time insights with a simple setup."
