...
1. **Update Connected App Scopes**: Click the checkbox for different business groups to expand the scope permissions.
...
2. **Add Scopes for Other Business Groups**: Ensure you add the same scopes for each business group you want to monitor.
...
3. **Configure Business Group IDs**: In the connected app properties, add multiple business group IDs separated by commas (`,`).
