---
title: "Set Up Treblle in .NET | Treblle Docs"
description: "Integrate Treblle with .NET to capture API requests, track errors, and enhance security. Follow our setup guide to configure Treblle for real-time API observability."
