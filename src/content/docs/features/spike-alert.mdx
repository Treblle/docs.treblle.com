...
image: "/og-images/treblle-spike-alerts.jpg"
---
...
- **Baseline comparison**: Compares current traffic to historical averages
...
- Traffic volume comparison (current vs. baseline)
