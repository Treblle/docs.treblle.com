...
### SSO with Treblle
- **Prerequisites for SSO with Treblle**: Team's identity provider (IdP) must support the SAML 2.0 standard.
- **Treblle Supports all the major idPs**: like Microsoft AD FS, Microsoft Entra ID, Custom SAML, Google Workspace, Okta, OneLogin, and Ping Identity
