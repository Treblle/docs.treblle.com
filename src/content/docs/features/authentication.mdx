...
1. **Navigate to Authentication Settings**
   ...
   ![SSO Empty State](/platform/authentication/sso-empty.png)
...
2. **Choose Your Authentication Type**
   ...
   ![SSO Configuration Type](/platform/authentication/sso-config-type.png)
...
3. **Input Required Fields**
   ...
   ![SSO Configuration](/platform/authentication/sso-config.png)

4. **Save and Test Configuration**
   - Test the setup to ensure successful authentication.

   ![SSO Configuration Complete](/platform/authentication/sso.png)
...
5. **Log In with SSO**
   ...
   ![SSO Sign In](/platform/authentication/sso-sign-in.png)
...
1. **Go to Account Settings**
   ...
   ![MFA Settings](/platform/authentication/mfa.png)

2. **Enable MFA**
   - Click **Enable MFA** to generate a QR code.

   ![Enable MFA](/platform/authentication/mfa-enable.png)
...
![Social Sign On](/platform/authentication/social-sign-on.png)
