...
With Treblle 3.0, we offer authentication features like Single Sign-On (SSO), Multi-Factor Authentication (MFA), and Social Sign-On to secure your workspace effectively.
...
5. **Log In with SSO**
   ...
   - Go to the Treblle <a href="https://identity.treblle.com/login" target="_blank" rel="noopener noreferrer"> Sign-In</a> page.
...
<img
  src="/platform/authentication/single-sign-on.png"
  width="300"
  style={{ borderRadius: "8px" }}
/>
